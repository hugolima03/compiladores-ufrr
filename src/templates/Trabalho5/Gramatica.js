...
export default class Gramatica {
    ...
    /**
     * Retorna o símbolo vazio da gramática
     * @return {string}
     */
    ...
    get producoes() {
        ...
        for (const snt of this._naoTerminais) {
            producoes = [
                ...producoes,
                ...this._buscarProducoesPorNaoTerminal(snt)
            ];
        }
        return producoes;
    }
    ...
    static criar (producoes, vazio) {
        ...
        for (const snt of gram._naoTerminais) {
            ...
            for (const st of prods) {
                ...
                gram._producoes[snt].push(new Producao(snt, corpo, gram.vazio));
    ...
    static _parsearCorpoProducao(str, ocorrencias) {
        ...
        locaisDivisao = locaisDivisao.filter((i, p) => locaisDivisao.indexOf(i) === p).sort();
